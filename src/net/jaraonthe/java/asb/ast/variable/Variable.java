...
/**
 * Anything that resembles a variable, including registers, parameters, and
 * local variables.
 * 
 * Contains stuff that all variable types have in common.
 *
...
abstract public class Variable
{
     ...
     * 0 if length is determined dynamically (i.e. via a length variable for a
     * local variable).
     */
     ...
     * @param maxLength
     */
    protected Variable(String name, int minLength, int maxLength)
    {
        this.name      = name;
